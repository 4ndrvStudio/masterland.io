...
namespace Den.Tools
{
	...
	public class ObjectsPool : MonoBehaviour
	{
		...
		private class Pool
		{
			...
			public List<Transition> currentDrafts;
			...
			public void AddItem(int targetCount)
			{
			...
			public List<Transition> GetDrafts() {
		...
		public List<Transition>[] currentDrafts = new List<Transition>[2];

		public List<Transition> GetDrafts(int index)
		{
			return pools[index].GetDrafts();
		}
